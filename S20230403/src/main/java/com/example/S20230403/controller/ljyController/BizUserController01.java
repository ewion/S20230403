...
import com.example.S20230403.service.ljyService.OwnerUser01;
import com.example.S20230403.service.ljyService.SukbakService01;
...
public class BizUserController01 {
	...
	public String bizMain(String user_id, Model model) {
	...
	public String accomInsertForm (@ModelAttribute(value = "user_id") String user_id, Model model) {
	...
	public String accomInsert(OwnerUser01 ownerUser, Model model) {
...
//		OwnerUser ou = new OwnerUser(accom);
	...
	private String usersInfoChk (@ModelAttribute(value = "password")String insertPassword, 
								 @ModelAttribute(value = "userAction")String userAction,
								 Model model) {
		System.out.println("userAction -> "+userAction);
		System.out.println("insertPassword -> "+insertPassword);
//		String user_id = session.get
		String user_id = "hy@aa.a";
...
//		room = ss01.roomSelect(biz_id, r_id);
	...
	@PostMapping(value = "/biz/example2")
	...
	@PostMapping(value = "/biz/example3")
